...
class DspFragment : Fragment(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private val searchableCards = listOf(
        ...
        CardEntry(R.id.card_imaging, R.string.imaging_enable),
        CardEntry(R.id.card_transient, R.string.transient_enable),
        ...
        CardEntry(R.id.card_balance, R.string.balance_enable),
    ...
    private val deferredCardSpecs = listOf(
        ...
        CardSpec(R.id.card_imaging, Constants.PREF_IMAGING, R.xml.dsp_imaging_preferences),
        CardSpec(R.id.card_transient, Constants.PREF_TRANSIENT, R.xml.dsp_transient_preferences),
        ...
        CardSpec(R.id.card_balance, Constants.PREF_BALANCE, R.xml.dsp_balance_preferences),
